...
export default function Certificate() {
  ...
  return (
    <>
      <section
        id="certificate"
        className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#F4F4FF] to-[#EAEAFF] py-24 px-6"
      >
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="max-w-7xl w-full bg-white rounded-3xl shadow-2xl border border-[#dcdcff] p-10 md:p-16 text-center"
        >
          {/* Judul */}
          <motion.h2
